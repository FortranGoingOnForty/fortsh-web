...
const navigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: "alias", href: "/docs/builtins/alias" },
      { title: "cd", href: "/docs/builtins/cd" },
      { title: "command", href: "/docs/builtins/command" },
      { title: "declare", href: "/docs/builtins/declare" },
      { title: "echo", href: "/docs/builtins/echo" },
      { title: "eval", href: "/docs/builtins/eval" },
      { title: "exec", href: "/docs/builtins/exec" },
      { title: "export", href: "/docs/builtins/export" },
      { title: "fg / bg", href: "/docs/builtins/fg" },
      { title: "getopts", href: "/docs/builtins/getopts" },
      { title: "hash", href: "/docs/builtins/hash" },
      { title: "history", href: "/docs/builtins/history" },
      { title: "jobs", href: "/docs/builtins/jobs" },
      { title: "kill", href: "/docs/builtins/kill" },
      { title: "let", href: "/docs/builtins/let" },
      { title: "local", href: "/docs/builtins/local" },
      { title: "printf", href: "/docs/builtins/printf" },
      { title: "pushd / popd", href: "/docs/builtins/pushd" },
      { title: "pwd", href: "/docs/builtins/pwd" },
      { title: "read", href: "/docs/builtins/read" },
      { title: "readonly", href: "/docs/builtins/readonly" },
      { title: "set", href: "/docs/builtins/set" },
      { title: "shift", href: "/docs/builtins/shift" },
      { title: "shopt", href: "/docs/builtins/shopt" },
      { title: "source", href: "/docs/builtins/source" },
      { title: "test", href: "/docs/builtins/test" },
      { title: "trap", href: "/docs/builtins/trap" },
      { title: "type", href: "/docs/builtins/type" },
      { title: "umask", href: "/docs/builtins/umask" },
      { title: "unset", href: "/docs/builtins/unset" },
      { title: "wait", href: "/docs/builtins/wait" },
    ],
  },
  {
    title: "Variables",
